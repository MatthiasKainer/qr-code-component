 ...
 */
const t="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,e=(t,e,s=null)=>{for(;e!==s;){const s=e.nextSibling;t.removeChild(e),e=s}},s=`{{lit-${String(Math.random()).slice(2)}}}`,i=`\x3c!--${s}--\x3e`,n=new RegExp(`${s}|${i}`);class r{constructor(t,e){this.parts=[],this.element=e;const i=[],r=[],h=document.createTreeWalker(e.content,133,null,!1);let u=0,l=-1,f=0;const{strings:d,values:{length:v}}=t;for(;f<v;){const t=h.nextNode();if(null!==t){if(l++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:s}=e;let i=0;for(let t=0;t<s;t++)o(e[t].name,"$lit$")&&i++;for(;i-- >0;){const e=d[f],s=a.exec(e)[2],i=s.toLowerCase()+"$lit$",r=t.getAttribute(i);t.removeAttribute(i);const o=r.split(n);this.parts.push({type:"attribute",index:l,name:s,strings:o}),f+=o.length-1}}"TEMPLATE"===t.tagName&&(r.push(t),h.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(s)>=0){const s=t.parentNode,r=e.split(n),h=r.length-1;for(let e=0;e<h;e++){let i,n=r[e];if(""===n)i=c();else{const t=a.exec(n);null!==t&&o(t[2],"$lit$")&&(n=n.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),i=document.createTextNode(n)}s.insertBefore(i,t),this.parts.push({type:"node",index:++l})}""===r[h]?(s.insertBefore(c(),t),i.push(t)):t.data=r[h],f+=h}}else if(8===t.nodeType)if(t.data===s){const e=t.parentNode;null!==t.previousSibling&&l!==u||(l++,e.insertBefore(c(),t)),u=l,this.parts.push({type:"node",index:l}),null===t.nextSibling?t.data="":(i.push(t),l--),f++}else{let e=-1;for(;-1!==(e=t.data.indexOf(s,e+1));)this.parts.push({type:"node",index:-1}),f++}}else h.currentNode=r.pop()}for(const t of i)t.parentNode.removeChild(t)}}const o=(t,e)=>{const s=t.length-e.length;return s>=0&&t.slice(s)===e},h=t=>-1!==t.index,c=()=>document.createComment(""),a=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function u(t,e){const{element:{content:s},parts:i}=t,n=document.createTreeWalker(s,133,null,!1);let r=f(i),o=i[r],h=-1,c=0;const a=[];let u=null;for(;n.nextNode();){h++;const t=n.currentNode;for(t.previousSibling===u&&(u=null),e.has(t)&&(a.push(t),null===u&&(u=t)),null!==u&&c++;void 0!==o&&o.index===h;)o.index=null!==u?-1:o.index-c,r=f(i,r),o=i[r]}a.forEach(t=>t.parentNode.removeChild(t))}const l=t=>{let e=11===t.nodeType?0:1;const s=document.createTreeWalker(t,133,null,!1);for(;s.nextNode();)e++;return e},f=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(h(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const d=new WeakMap,v=t=>"function"==typeof t&&d.has(t),p={},w={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class m{constructor(t,e,s){this.t=[],this.template=t,this.processor=e,this.options=s}update(t){let e=0;for(const s of this.t)void 0!==s&&s.setValue(t[e]),e++;for(const t of this.t)void 0!==t&&t.commit()}_clone(){const e=t?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),s=[],i=this.template.parts,n=document.createTreeWalker(e,133,null,!1);let r,o=0,c=0,a=n.nextNode();for(;o<i.length;)if(r=i[o],h(r)){for(;c<r.index;)c++,"TEMPLATE"===a.nodeName&&(s.push(a),n.currentNode=a.content),null===(a=n.nextNode())&&(n.currentNode=s.pop(),a=n.nextNode());if("node"===r.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(a.previousSibling),this.t.push(t)}else this.t.push(...this.processor.handleAttributeExpressions(a,r.name,r.strings,this.options));o++}else this.t.push(void 0),o++;return t&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=` ${s} `;class g{constructor(t,e,s,i){this.strings=t,this.values=e,this.type=s,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let r=0;r<t;r++){const t=this.strings[r],o=t.lastIndexOf("\x3c!--");n=(o>-1||n)&&-1===t.indexOf("--\x3e",o+1);const h=a.exec(t);e+=null===h?t+(n?y:i):t.substr(0,h.index)+h[1]+h[2]+"$lit$"+h[3]+s}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const b=t=>null===t||!("object"==typeof t||"function"==typeof t),x=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class S{constructor(t,e,s){this.dirty=!0,this.element=t,this.name=e,this.strings=s,this.parts=[];for(let t=0;t<s.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new _(this)}_getValue(){const t=this.strings,e=t.length-1;let s="";for(let i=0;i<e;i++){s+=t[i];const e=this.parts[i];if(void 0!==e){const t=e.value;if(b(t)||!x(t))s+="string"==typeof t?t:String(t);else for(const e of t)s+="string"==typeof e?e:String(e)}}return s+=t[e],s}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class _{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===p||b(t)&&t===this.value||(this.value=t,v(t)||(this.committer.dirty=!0))}commit(){for(;v(this.value);){const t=this.value;this.value=p,t(this)}this.value!==p&&this.committer.commit()}}class k{constructor(t){this.value=void 0,this.s=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(c()),this.endNode=t.appendChild(c())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.i(this.startNode=c()),t.i(this.endNode=c())}insertAfterPart(t){t.i(this.startNode=c()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.s=t}commit(){if(null===this.startNode.parentNode)return;for(;v(this.s);){const t=this.s;this.s=p,t(this)}const t=this.s;t!==p&&(b(t)?t!==this.value&&this.o(t):t instanceof g?this.h(t):t instanceof Node?this.u(t):x(t)?this.l(t):t===w?(this.value=w,this.clear()):this.o(t))}i(t){this.endNode.parentNode.insertBefore(t,this.endNode)}u(t){this.value!==t&&(this.clear(),this.i(t),this.value=t)}o(t){const e=this.startNode.nextSibling,s="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=s:this.u(document.createTextNode(s)),this.value=t}h(t){const e=this.options.templateFactory(t);if(this.value instanceof m&&this.value.template===e)this.value.update(t.values);else{const s=new m(e,t.processor,this.options),i=s._clone();s.update(t.values),this.u(i),this.value=s}}l(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let s,i=0;for(const n of t)s=e[i],void 0===s&&(s=new k(this.options),e.push(s),0===i?s.appendIntoPart(this):s.insertAfterPart(e[i-1])),s.setValue(n),s.commit(),i++;i<e.length&&(e.length=i,this.clear(s&&s.endNode))}clear(t=this.startNode){e(this.startNode.parentNode,t.nextSibling,this.endNode)}}class M{constructor(t,e,s){if(this.value=void 0,this.s=void 0,2!==s.length||""!==s[0]||""!==s[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=s}setValue(t){this.s=t}commit(){for(;v(this.s);){const t=this.s;this.s=p,t(this)}if(this.s===p)return;const t=!!this.s;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.s=p}}class $ extends S{constructor(t,e,s){super(t,e,s),this.single=2===s.length&&""===s[0]&&""===s[1]}_createPart(){return new C(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class C extends _{}let F=!1;(()=>{try{const t={get capture(){return F=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class A{constructor(t,e,s){this.value=void 0,this.s=void 0,this.element=t,this.eventName=e,this.eventContext=s,this.v=t=>this.handleEvent(t)}setValue(t){this.s=t}commit(){for(;v(this.s);){const t=this.s;this.s=p,t(this)}if(this.s===p)return;const t=this.s,e=this.value,s=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),i=null!=t&&(null==e||s);s&&this.element.removeEventListener(this.eventName,this.v,this.p),i&&(this.p=P(t),this.element.addEventListener(this.eventName,this.v,this.p)),this.value=t,this.s=p}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const P=t=>t&&(F?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const n=e[0];if("."===n){return new $(t,e.slice(1),s).parts}return"@"===n?[new A(t,e.slice(1),i.eventContext)]:"?"===n?[new M(t,e.slice(1),s)]:new S(t,e,s).parts}handleTextExpression(t){return new k(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const U=(t,...e)=>new g(t,e,"html",T)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const W=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?Object.assign(Object.assign({},e),{finisher(s){s.createProperty(e.key,t)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(s){s.createProperty(e.key,t)}};
/**
@license
...
function(t,e){for(var s="length",i=[null,[[10,7,17,13],[1,1,1,1],[]],[[16,10,28,22],[1,1,1,1],[4,16]],[[26,15,22,18],[1,1,2,2],[4,20]],[[18,20,16,26],[2,1,4,2],[4,24]],[[24,26,22,18],[2,1,4,4],[4,28]],[[16,18,28,24],[4,2,4,4],[4,32]],[[18,20,26,18],[4,2,5,6],[4,20,36]],[[22,24,26,22],[4,2,6,6],[4,22,40]],[[22,30,24,20],[5,2,8,8],[4,24,44]],[[26,18,28,24],[5,4,8,8],[4,26,48]],[[30,20,24,28],[5,4,11,8],[4,28,52]],[[22,24,28,26],[8,4,11,10],[4,30,56]],[[22,26,22,24],[9,4,16,12],[4,32,60]],[[24,30,24,20],[9,4,16,16],[4,24,44,64]],[[24,22,24,30],[10,6,18,12],[4,24,46,68]],[[28,24,30,24],[10,6,16,17],[4,24,48,72]],[[28,28,28,28],[11,6,19,16],[4,28,52,76]],[[26,30,28,28],[13,6,21,18],[4,28,54,80]],[[26,28,26,26],[14,7,25,21],[4,28,56,84]],[[26,28,28,30],[16,8,25,20],[4,32,60,88]],[[26,28,30,28],[17,8,25,23],[4,26,48,70,92]],[[28,28,24,30],[17,9,34,23],[4,24,48,72,96]],[[28,30,30,30],[18,9,30,25],[4,28,52,76,100]],[[28,30,30,30],[20,10,32,27],[4,26,52,78,104]],[[28,26,30,30],[21,12,35,29],[4,30,56,82,108]],[[28,28,30,28],[23,12,37,34],[4,28,56,84,112]],[[28,30,30,30],[25,12,40,34],[4,32,60,88,116]],[[28,30,30,30],[26,13,42,35],[4,24,48,72,96,120]],[[28,30,30,30],[28,14,45,38],[4,28,52,76,100,124]],[[28,30,30,30],[29,15,48,40],[4,24,50,76,102,128]],[[28,30,30,30],[31,16,51,43],[4,28,54,80,106,132]],[[28,30,30,30],[33,17,54,45],[4,32,58,84,110,136]],[[28,30,30,30],[35,18,57,48],[4,28,56,84,112,140]],[[28,30,30,30],[37,19,60,51],[4,32,60,88,116,144]],[[28,30,30,30],[38,19,63,53],[4,28,52,76,100,124,148]],[[28,30,30,30],[40,20,66,56],[4,22,48,74,100,126,152]],[[28,30,30,30],[43,21,70,59],[4,26,52,78,104,130,156]],[[28,30,30,30],[45,22,74,62],[4,30,56,82,108,134,160]],[[28,30,30,30],[47,24,77,65],[4,24,52,80,108,136,164]],[[28,30,30,30],[49,25,81,68],[4,28,56,84,112,140,168]]],n=/^\d*$/,r=/^[A-Za-z0-9 $%*+\-./:] * $ /,o=/^[A-Z0-9 $%*+\-./:] * $ /,h=[],c=[-1],a=0,u=1;a<255;++a)h.push(u),c[u]=a,u=2*u^(u>=128?285:0);for(var l=[[]],f=0;f<30;++f){for(var d=l[f],v=[],p=0;p<=f;++p){var w=p<f?h[d[p]]:0,m=h[(f+(d[p-1]||0))%255];v.push(c[w^m])}l.push(v)}for(var y={},g=0;g<45;++g)y["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:".charAt(g)]=g;var b=[function(t,e){return(t+e)%2==0},function(t){return t%2==0},function(t,e){return e%3==0},function(t,e){return(t+e)%3==0},function(t,e){return((t/2|0)+(e/3|0))%2==0},function(t,e){return t*e%2+t*e%3==0},function(t,e){return(t*e%2+t*e%3)%2==0},function(t,e){return((t+e)%2+t*e%3)%2==0}],x=function(t){return t>6},S=function(t,e){var n=-8&function(t){var e=i[t],n=16*t*t+128*t+64;return x(t)&&(n-=36),e[2][s]&&(n-=25*e[2][s]*e[2][s]-10*e[2][s]-55),n}(t),r=i[t];return n-=8*r[0][e]*r[1][e]},_=function(t,e){switch(e){case 1:return t<10?10:t<27?12:14;case 2:return t<10?9:t<27?11:13;case 4:return t<10?8:16;case 8:return t<10?8:t<27?10:12}},k=function(t,e,s){var i=S(t,s)-4-_(t,e);switch(e){case 1:return 3*(i/10|0)+(i%10<4?0:i%10<7?1:2);case 2:return 2*(i/11|0)+(i%11<6?0:1);case 4:return i/8|0;case 8:return i/13|0}},M=function(t,e){for(var i=t.slice(0),n=t[s],r=e[s],o=0;o<r;++o)i.push(0);for(var a=0;a<n;){var u=c[i[a++]];if(u>=0)for(var l=0;l<r;++l)i[a+l]^=h[(u+e[l])%255]}return i.slice(n)},$=function(t,e,s,i){for(var n=t<<i,r=e-1;r>=0;--r)n>>i+r&1&&(n^=s<<r);return t<<i|n},C=function(t,e,i){for(var n=b[i],r=t[s],o=0;o<r;++o)for(var h=0;h<r;++h)e[o][h]||(t[o][h]^=n(o,h));return t},F=function(t,e,i,n){for(var r=t[s],o=21522^$(i<<3|n,5,1335,10),h=0;h<15;++h){var c=[r-1,r-2,r-3,r-4,r-5,r-6,r-7,r-8,7,5,4,3,2,1,0][h];t[[0,1,2,3,4,5,7,8,r-7,r-6,r-5,r-4,r-3,r-2,r-1][h]][8]=t[8][c]=o>>h&1}return t},A=function(t){for(var e=function(t){for(var e=0,i=0;i<t[s];++i)t[i]>=5&&(e+=t[i]-5+3);for(var n=5;n<t[s];n+=2){var r=t[n];t[n-1]===r&&t[n-2]===3*r&&t[n-3]===r&&t[n-4]===r&&(t[n-5]>=4*r||t[n+1]>=4*r)&&(e+=40)}return e},i=t[s],n=0,r=0,o=0;o<i;++o){var h,c=t[o];h=[0];for(var a=0;a<i;){var u;for(u=0;a<i&&c[a];++u)++a;for(h.push(u),u=0;a<i&&!c[a];++u)++a;h.push(u)}n+=e(h),h=[0];for(var l=0;l<i;){var f;for(f=0;l<i&&t[l][o];++f)++l;for(h.push(f),f=0;l<i&&!t[l][o];++f)++l;h.push(f)}n+=e(h);var d=t[o+1]||[];r+=c[0];for(var v=1;v<i;++v){var p=c[v];r+=p,c[v-1]===p&&d[v]===p&&d[v-1]===p&&(n+=3)}}return n+=10*(Math.abs(r/i/i-.5)/.05|0)},P=function(t,e,n,r,o){var h=i[e],c=function(t,e,i,n){var r=[],o=0,h=8,c=i[s],a=function(t,e){if(e>=h){for(r.push(o|t>>(e-=h));e>=8;)r.push(t>>(e-=8)&255);o=0,h=8}e>0&&(o|=(t&(1<<e)-1)<<(h-=e))},u=_(t,e);switch(a(e,4),a(c,u),e){case 1:for(var l=2;l<c;l+=3)a(parseInt(i.substring(l-2,l+1),10),10);a(parseInt(i.substring(l-2),10),[0,4,7][c%3]);break;case 2:for(var f=1;f<c;f+=2)a(45*y[i.charAt(f-1)]+y[i.charAt(f)],11);c%2==1&&a(y[i.charAt(f-1)],6);break;case 4:for(var d=0;d<c;++d)a(i[d],8)}for(a(0,4),h<8&&r.push(o);r[s]+1<n;)r.push(236,17);return r[s]<n&&r.push(236),r}(e,n,t,S(e,r)>>3);c=function(t,e,i){for(var n=[],r=t[s]/e|0,o=0,h=e-t[s]%e,c=0;c<h;++c)n.push(o),o+=r;for(var a=h;a<e;++a)n.push(o),o+=r+1;n.push(o);for(var u=[],l=0;l<e;++l)u.push(M(t.slice(n[l],n[l+1]),i));for(var f=[],d=t[s]/e|0,v=0;v<d;++v)for(var p=0;p<e;++p)f.push(t[n[p]+v]);for(var w=h;w<e;++w)f.push(t[n[w+1]-1]);for(var m=0;m<i[s];++m)for(var y=0;y<e;++y)f.push(u[y][m]);return f}(c,h[1][r],l[h[0][r]]);var a=function(t){for(var e=i[t],n=function(t){return 4*t+17}(t),r=[],o=[],h=0;h<n;++h)r.push([]),o.push([]);var c=function(t,e,s,i,n){for(var h=0;h<s;++h)for(var c=0;c<i;++c)r[t+h][e+c]=n[h]>>c&1,o[t+h][e+c]=1};c(0,0,9,9,[127,65,93,93,93,65,383,0,64]),c(n-8,0,8,9,[256,127,65,93,93,93,65,127]),c(0,n-8,9,8,[254,130,186,186,186,130,254,0,0]);for(var a=9;a<n-8;++a)r[6][a]=r[a][6]=1&~a,o[6][a]=o[a][6]=1;for(var u=e[2],l=u[s],f=0;f<l;++f)for(var d=0===f?l-1:l,v=0===f||f===l-1?1:0;v<d;++v)c(u[f],u[v],5,5,[31,17,21,17,31]);if(x(t))for(var p=$(t,6,7973,12),w=0,m=0;m<6;++m)for(var y=0;y<3;++y)r[m][n-11+y]=r[n-11+y][m]=p>>w++&1,o[m][n-11+y]=o[n-11+y][m]=1;return{matrix:r,reserved:o}}(e),u=a.matrix,f=a.reserved;if(function(t,e,i){for(var n=t[s],r=0,o=-1,h=n-1;h>=0;h-=2){6===h&&--h;for(var c=o<0?n-1:0,a=0;a<n;++a){for(var u=h;u>h-2;--u)e[c][u]||(t[c][u]=i[r>>3]>>(7&~r)&1,++r);c+=o}o=-o}}(u,f,c),o<0){C(u,f,0),F(u,0,r,0);var d=0,v=A(u);for(C(u,f,0),o=1;o<8;++o){C(u,f,o),F(u,0,r,o);var p=A(u);v>p&&(v=p,d=o),C(u,f,o)}o=d}return C(u,f,o),F(u,0,r,o),u},E={generate:function(t,e){var i=e||{},h={numeric:1,alphanumeric:2,octet:4},c={L:1,M:0,Q:3,H:2},a=i.version||-1,u=c[(i.ecclevel||"L").toUpperCase()],l=i.mode?h[i.mode.toLowerCase()]:-1,f="mask"in i?i.mask:-1;if(l<0)l="string"==typeof t?t.match(n)?1:t.match(o)?2:4:4;else if(1!==l&&2!==l&&4!==l)throw"invalid or unsupported mode";if(null===(t=function(t,e){switch(t){case 1:return e.match(n)?e:null;case 2:return e.match(r)?e.toUpperCase():null;case 4:if("string"==typeof e){for(var i=[],o=0;o<e[s];++o){var h=e.charCodeAt(o);h<128?i.push(h):h<2048?i.push(192|h>>6,128|63&h):h<65536?i.push(224|h>>12,128|h>>6&63,128|63&h):i.push(240|h>>18,128|h>>12&63,128|h>>6&63,128|63&h)}return i}return e}}(l,t)))throw"invalid data format";if(u<0||u>3)throw"invalid ECC level";if(a<0){for(a=1;a<=40&&!(t[s]<=k(a,l,u));++a);if(a>40)throw"too large data"}else if(a<1||a>40)throw"invalid version";if(-1!==f&&(f<0||f>8))throw"invalid mask";return P(t,a,l,u,f)},generateHTML:function(t,i){for(var n=i||{},r=n.fillcolor?n.fillcolor:"#FFFFFF",o=n.textcolor?n.textcolor:"#000000",h=E.generate(t,n),c=Math.max(n.modulesize||5,.5),a=Math.max(null!==n.margin?n.margin:4,0),u=e.createElement("div"),l=h[s],f=['<table border="0" cellspacing="0" cellpadding="0" style="border:'+c*a+"px solid "+r+";background:"+r+'">'],d=0;d<l;++d){f.push("<tr>");for(var v=0;v<l;++v)f.push('<td style="width:'+c+"px;height:"+c+"px"+(h[d][v]?";background:"+o:"")+'"></td>');f.push("</tr>")}u.className="qrcode";var p=e.createRange();p.selectNodeContents(u);var w=p.createContextualFragment(f.join("")+"</table>");return u.appendChild(w),u},generateSVG:function(t,i){var n=i||{},r=n.fillcolor?n.fillcolor:"#FFFFFF",o=n.textcolor?n.textcolor:"#000000",h=E.generate(t,n),c=h[s],a=Math.max(n.modulesize||5,.5),u=Math.max(n.margin?n.margin:4,0),l=a*(c+2*u),f=e.createElementNS("http://www.w3.org/2000/svg","svg");f.setAttributeNS(null,"viewBox","0 0 "+l+" "+l),f.setAttributeNS(null,"style","shape-rendering:crispEdges");var d="qrcode"+Date.now();f.setAttributeNS(null,"id",d);var v=e.createDocumentFragment(),p=e.createElementNS("http://www.w3.org/2000/svg","style");p.appendChild(e.createTextNode("#"+d+" .bg{fill:"+r+"}#"+d+" .fg{fill:"+o+"}")),v.appendChild(p);var w=function(t,s,i,n,r){var o=e.createElementNS("http://www.w3.org/2000/svg","rect")||"";return o.setAttributeNS(null,"class",t),o.setAttributeNS(null,"fill",s),o.setAttributeNS(null,"x",i),o.setAttributeNS(null,"y",n),o.setAttributeNS(null,"width",r),o.setAttributeNS(null,"height",r),o};v.appendChild(w("bg","none",0,0,l));for(var m=u*a,y=0;y<c;++y){for(var g=u*a,b=0;b<c;++b)h[y][b]&&v.appendChild(w("fg","none",g,m,a)),g+=a;m+=a}return f.appendChild(v),f},generatePNG:function(t,i){var n,r=i||{},o=r.fillcolor||"#FFFFFF",h=r.textcolor||"#000000",c=E.generate(t,r),a=Math.max(r.modulesize||5,.5),u=Math.max(null!==r.margin&&void 0!==r.margin?r.margin:4,0),l=c[s],f=a*(l+2*u),d=e.createElement("canvas");if(d.width=d.height=f,!(n=d.getContext("2d")))throw"canvas support is needed for PNG output";n.fillStyle=o,n.fillRect(0,0,f,f),n.fillStyle=h;for(var v=0;v<l;++v)for(var p=0;p<l;++p)c[v][p]&&n.fillRect(a*(u+p),a*(u+v),a,a);return d.toDataURL()}};t.QRCode=E}("undefined"!=typeof window?window:void 0,document);var X=function(t,e,s,i){for(var n,r=arguments.length,o=r<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,s):i,h=t.length-1;h>=0;h--)(n=t[h])&&(o=(r<3?n(o):r>3?n(e,s,o):n(e,s))||o);return r>3&&o&&Object.defineProperty(e,s,o),o};let Y=class extends K{constructor(){super(),this.text="",window.addEventListener("message",t=>{const{type:e,text:s}=t.data;t.origin===window.location.origin&&t.source===window&&s&&"qr-code.changeText"===e&&(this.text=s)},!1)}render(){return this.text?U`<div class="qrCanvas" 
  ...
  `,X([(t,e)=>void 0!==e?((t,e,s)=>{e.constructor.createProperty(s,t)})(tt,t,e):W(tt,t)],Y.prototype,"text",void 0),Y=X([(et="qr-code",t=>"function"==typeof t?((t,e)=>(window.customElements.define(t,e),e))(et,t):((t,e)=>{const{kind:s,elements:i}=e;return{kind:s,elements:i,finisher(e){window.customElements.define(t,e)}}})(et,t))],Y);export{Y as QRCodeElement};
